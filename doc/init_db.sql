...
CREATE TABLE `sys_branch`  (
  ...
  `ancestor_Id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '祖先级Id , 3,2,1',
  ...
  `del_flag` int NULL DEFAULT 0 COMMENT '删除标记 (0-正常 1-删除)',
...
CREATE TABLE `sys_element`  (
  ...
  `parent_id` bigint(20) NULL DEFAULT 0 COMMENT '父级Id(顶级为0)',
  `type` int NULL DEFAULT 0 COMMENT '类型(0:其他 1:按钮 2:链接)',
...
CREATE TABLE `sys_menu`  (
  ...
  `is_show` int NULL DEFAULT NULL COMMENT '是否显示(1-显示,0-不显示)',
...
CREATE TABLE `sys_role`  (
  ...
  `status` int NULL DEFAULT 0 COMMENT '状态(0-停用 1-启用)',
  `gmt_created` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  `creator` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `gmt_modified` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `updater` bigint(20) NULL DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `sys_role_link`  (
  ...
  `type` int NULL DEFAULT 0 COMMENT '类型( 0:菜单 1:页面元素 )',
...
CREATE TABLE `sys_user`  (
  ...
  `status` int NULL DEFAULT 0 COMMENT '状态值(1-正常, 0-禁用)',
  `gmt_created` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  `creator` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `gmt_modified` timestamp(0) NULL DEFAULT NULL COMMENT '更新时间',
  `updater` bigint(20) NULL DEFAULT NULL COMMENT '更新人',
